...
const projectId = '2GeCDqTwHMKK';
const sessionId = 't4j0roSvooUBJECn';
const token = 'workflow-browser-token-7341';
const url = `http://127.0.0.1:5183/projects/${projectId}/sessions/${sessionId}`;
...
await page.screenshot({ path: 'output/playwright/workflow-browser-answer-route-7341.png', fullPage: true });
...
writeFileSync('output/playwright/workflow-browser-answer-route-7341.json', JSON.stringify(result, null, 2));
