...
- [x] **Step 3: 保存时同时更新 workflow role**
...
- [x] **Step 1: 创建 WorkflowTimeline 组件**
...
- [x] **Step 2: 在 TaskDetailPanel 查询 workflow**
...
- [x] **Step 3: 增加 workflow 操作 mutations**
...
- [x] **Step 1: RoomPage 查询 workflow 列表**
...
- [x] **Step 2: RoomPage 处理 workflow WS 事件**
...
- [x] **Step 3: TaskBoard 接收 workflows**
...
- [x] **Step 4: TaskCard 展示 workflow badge**
...
- [x] **Step 5: RoomPage 传递 workflows**
