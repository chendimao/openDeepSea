...
- [ ] **Step 1: 写失败测试，验证 active session summary 暴露创建和最后查看时间**
...
- [ ] **Step 2: 写失败测试，验证 project switcher 暴露项目更新时间**
...
- [ ] **Step 1: 写失败测试，验证 `projectSessionToActiveSummary` 输出新字段**
...
- [ ] **Step 2: 更新 SessionShell fixture 的预期失败点**
...
- [ ] **Step 5: 修改 `projectSessionToActiveSummary`**
...
- [ ] **Step 6: 同步 `SessionShell.test.tsx` fixture**
...
- [ ] **Step 1: 在测试文件中加入可复用 summary helper**
...
- [ ] **Step 2: 写失败测试，验证 updated 排序使用 `last_viewed_at ?? updated_at`**
...
- [ ] **Step 6: 在 `SessionShellView.tsx` 增加类型和偏好 helpers**
...
- [ ] **Step 8: 修正当前会话 fallback summary 新字段**
...
- [ ] **Step 1: 改造测试 localStorage helper**
...
- [ ] **Step 6: 给 `SessionShell` 和 `SessionShellView` 增加 `onCreateProject` prop**
...
- [ ] **Step 7: 在 `ProjectSessionTreeRail` 中接入偏好状态和模型**
...
- [ ] **Step 11: 修改 session row 时间显示并新增 time row**
