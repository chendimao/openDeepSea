...
Run: `npm --workspace packages/frontend test -- SessionShell`

Expected: FAIL，原因包含 `data-workflow-mission-strip="true"` 未找到。

- [ ] **Step 3: 实现 Mission Strip 组件骨架**
