...
- [x] **Step 1: Write graph E2E test with fake agents**
...
- [x] **Step 2: Run E2E test to verify failure or pass**
...
- [x] **Step 3: Update design doc with phase B implementation note**
...
- [x] **Step 4: Run backend graph test suite**
