...
- [ ] **Step 4: 新增 routing prompt builder**
...
- [ ] **Step 5: 增加 auto advance dispatcher**
...
- [ ] **Step 6: 扩展 phase 映射与 evidence 校验**
...
- [ ] **Step 2: 运行测试确认失败或错误文案不足**

Run: `npm run test -w @openclaw-room/backend -- src/task-actions.test.ts`

Expected: 如果当前已有 failed 事件但错误为空，FAIL 在 error 断言。

- [ ] **Step 3: 改进 phase runner error**
...
- [ ] **Step 3: 扩展 action 列表与 state evidence**
...
- [ ] **Step 1: 更新 TaskActionStrip RED 测试**
