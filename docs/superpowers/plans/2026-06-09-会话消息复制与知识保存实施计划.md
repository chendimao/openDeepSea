...
- [ ] **Step 1: 在 `SessionShellView.tsx` 新增统一类型和 action key helper**
...
- [ ] **Step 2: 更新 `SessionShellView` props**
...
- [ ] **Step 3: 更新 `TranscriptCanvas` props**
...
- [ ] **Step 4: 更新 `TranscriptMessage` props 和保存状态**
...
- [ ] **Step 5: 更新 `SessionShell.tsx` 透传类型**
...
- [ ] **Step 6: 更新 `SessionWorkspacePage.tsx` mutation**
