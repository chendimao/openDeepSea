...
- [ ] **Step 1: 在 `SessionShellView.tsx` 增加图标 imports**
...
- [ ] **Step 2: 在 `TranscriptCanvas` 中增加复制状态和 helper**
...
- [ ] **Step 4: 在 `TranscriptMessage` 里生成复制按钮**
...
- [ ] **Step 5: 调整 `SessionMessageBubble.tsx` 头部工具组结构**
