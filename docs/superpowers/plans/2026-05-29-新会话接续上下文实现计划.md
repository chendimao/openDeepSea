...
- [x] **Step 4: Add DB columns and migration**
...
- [x] **Step 5: Update room agent repository**
...
- [x] **Step 3: Implement pure builder**
...
- [x] **Step 4: Update protocol client prompt construction**
...
- [x] **Step 5: Update legacy adapter prompt joining**
...
- [x] **Step 6: Run ACP protocol tests**
...
- [x] **Step 1: Write failing dispatcher test for first session**
...
- [x] **Step 2: Run dispatcher test to verify failure**
...
- [x] **Step 3: Add context collection helpers in dispatcher**
...
- [x] **Step 4: Pass handoff into adapter and persist prompt**
...
- [x] **Step 5: Persist and clear pending state**
