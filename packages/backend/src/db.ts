...
import { ensureOpenDeepSeaDataDir } from './data-dir.js';

const DATA_DIR = ensureOpenDeepSeaDataDir();
...
if (!settingsColumnNames.has('skills_sh_api_token')) {
  db.exec('ALTER TABLE settings ADD COLUMN skills_sh_api_token TEXT');
}
