...
function createRouteEdges(): WorkflowDefinitionGraph['edges'] {
  return [
    ...
    { from: 'agent_assignment', to: 'dispatch', condition: 'implementation' },
    ...
    { from: 'debug_plan_confirm', to: 'agent_assignment' },
    ...
    { from: 'spec_compliance_review', to: 'verification', condition: 'review_only' },
