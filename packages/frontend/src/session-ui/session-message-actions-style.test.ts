...
test('message copy knowledge and markdown actions share one compact toolbar style', () => {
  ...
  assert.match(sessionOsCss, /\.deepsea-message-tools \.deepsea-message__action\s*\{[^}]*min-height:\s*22px/s);
  ...
  assert.match(sessionOsCss, /\.deepsea-message-tools \.deepsea-message__action\s*\{[^}]*padding:\s*2px 7px/s);
  ...
  assert.match(sessionOsCss, /\.deepsea-message-tools \.deepsea-message__action svg\s*\{[^}]*width:\s*13px/s);
